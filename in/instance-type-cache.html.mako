      ...
      <div class="columns">
        ...
        <div class="column-right">
          ...
          <div class="sidebar-section ticket small">
            <span>Supported by <a target="_blank" href="https://LeanerCloud.com" class="text-decoration-none">Cristian Magherusan-Stanciu</a>, and developed in the open on Github.</span>
          </div>
        </div>
      </div>
    </div>
